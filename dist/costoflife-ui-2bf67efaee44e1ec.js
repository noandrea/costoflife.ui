...
function __wbg_adapter_18(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd48884d00f7b01e0(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {number}
*/
export function costoflife_per_diem(s) {
    const ptr0 = passStringToWasm0(s, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.costoflife_per_diem(ptr0, len0);
    return ret;
}
...
* @returns {number}
*/
export function costoflife_greetings() {
    const ret = wasm.costoflife_greetings();
    return ret;
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('costoflife-ui-2bf67efaee44e1ec_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
